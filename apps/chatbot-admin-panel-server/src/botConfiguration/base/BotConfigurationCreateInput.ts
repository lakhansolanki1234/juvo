...
@InputType()
class BotConfigurationCreateInput {
  @ApiProperty({
    required: false,
    type: () => ConversationFlowCreateNestedManyWithoutBotConfigurationsInput,
  })
  @ValidateNested()
  @Type(() => ConversationFlowCreateNestedManyWithoutBotConfigurationsInput)
  @IsOptional()
  @Field(() => ConversationFlowCreateNestedManyWithoutBotConfigurationsInput, {
    nullable: true,
  })
...
export { BotConfigurationCreateInput as BotConfigurationCreateInput };
